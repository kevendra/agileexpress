...
public class RegisterCommand extends SimpleCommand implements IResponder {
   public static const SUCCESS : String = "RegisterCommand.SUCCESS";
   public static const FAILURE : String = "RegisterCommand.FAILURE";
   override public function execute(notification : INotification) : void {
      ...
      var call : Object = service.register(proxy.user);
