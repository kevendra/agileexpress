    ...
    public class TitledBorderWindow extends TitleWindow {
        ...
        override protected function createBorder():void {
            if (!border && isBorderNeeded()) {
                ...
                rawChildren.addChildAt(UIComponent(border), 0);
            }
        }
        ...
        */
        ...
        override public function get borderMetrics():EdgeMetrics {
            ...
            var pl:Number = getNumberStyle("paddingLeft", 4);
            var pt:Number = getNumberStyle("paddingTop", 4);
            var pr:Number = getNumberStyle("paddingRight", 4);
            var pb:Number = getNumberStyle("paddingBottom", 4);
            ...
            return new EdgeMetrics(bt+pl, bt+pt+hh, bt+pr, bt+pb+cbh);
        }
        ...
        protected function drawBorderAndBackground(w:Number):void {
            if (border) {
                ...
                var g:Graphics = UIComponent(border).graphics;
                g.clear();
